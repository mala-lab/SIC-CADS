...
def add_detic_config(cfg):
    ...
    _C.MLR = CN()
    _C.MLR.ENABLE_MLR = False
    _C.MLR.EMBEDDING_PATH = ""
    _C.MLR.ENABLE_IMAGE_KD = True
    _C.MLR.MLR_LOSS_WEIGHT = 1.0
    _C.MLR.IMG_KD_LOSS_WEIGHT = 0.01
    _C.MLR.NORMED_EMBEDDING = True
    _C.MLR.LOGIT_SCALE = 1.0
    _C.MLR.CLIP_VERSION = "ViT-B/32"
    _C.MLR.MLR_CHECKPOINT = ""
    _C.MLR.LOAD_CLIP_IMG = False
    _C.MLR.CLIP_IMG_SIZE = 224
    _C.MLR.DATASET = "LVIS"
    _C.MLR.GLOBAL_DIM = 1280
    _C.MLR.CONFIG_PATH = ""
    _C.MLR.IGNORE_NOVEL = True
    _C.MLR.MULTI_SCALE = True
    _C.MLR.MULTI_SCALE_LEVELS = 2
    _C.MLR.CROSS_DATASET_EVAL = False
    _C.MLR.NUM_CLASSES = 1203
    _C.MLR.ONLINE_TRAIN = False
    _C.MLR.CLIP_IE_INFERENCE = True
    _C.MLR.NORMED_SCORE = True
    _C.MLR.LAMBDA_NOVEL = 0.8
    _C.MLR.LAMBDA_BASE = 0.8
    _C.MLR.GAMMA = 0.5
    _C.MLR.INFERENCE_RESOLUTION = 416
