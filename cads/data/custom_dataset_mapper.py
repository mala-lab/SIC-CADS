...
class CustomDatasetMapper(DatasetMapper):
    ...
    def __init__(self, is_train: bool, 
        ...
        **kwargs):
        ...
        self.load_img_clip = load_img_clip
        if self.load_img_clip:
            self.clip_img_size = clip_img_size
            self.clip_size = [clip_img_size, clip_img_size]
    ...
    def from_config(cls, cfg, is_train: bool = True):
        ...
        ret.update({
            ...
            "load_img_clip": cfg.MLR.LOAD_CLIP_IMG,
        ...
        if ret['use_diff_bs_size'] and is_train:
            ...
            elif cfg.INPUT.CUSTOM_AUG == 'RandomResizedCrop':    
                dataset_scales = cfg.DATALOADER.DATASET_INPUT_SCALE
                dataset_sizes = cfg.DATALOADER.DATASET_INPUT_SIZE
                ret['dataset_augs'] = [
                    build_custom_augmentation(cfg, True, scale, size) \
    ...
    def __call__(self, dataset_dict):
        ...
        if self.load_img_clip:
            # clip_img = cv2.resize(ori_image, self.clip_size)
            dataset_dict["clip_image"] = torch.as_tensor(
                np.ascontiguousarray(ori_image.transpose(2, 0, 1)))
